...
def w2v_feature_extract(root_path, filename, w2v_path):
    ...
    print("-----text-------:", X_train)
    pickle.dump([X_train_tid, X_train_w2v, X_train_bert, X_train, y_train, word_embeddings, relation, train_attention_mask_bert], open(root_path + "/weibo_files/train.pkl", 'wb'))
    pickle.dump([X_dev_tid, X_dev_w2v, X_dev_bert, X_dev, y_dev, dev_attention_mask_bert], open(root_path + "/weibo_files/dev.pkl", 'wb'))
    pickle.dump([X_test_tid, X_test_w2v, X_test_bert, X_test, y_test, test_attention_mask_bert], open(root_path + "/weibo_files/test.pkl", 'wb'))
